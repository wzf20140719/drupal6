 ...
 * and translation, and solve some theming issues.
 * This flag is checked on several
 ...
 *
 * @param $ret Array
 *        	to which results will be added.
 * @param $table Name
 ...
 * @param $type Type
 *        	of column
 * @param $attributes Additional
 *        	optional attributes. Recognized attributes:
 *        	not null => TRUE|FALSE
 *        	default => NULL|FALSE|value (the value must be enclosed in '' marks)
 * @return nothing, but modifies $ret parameter.
 */
 ...
 *        	of the table, without {}
 * @param $column Name
 *        	of the column to change
 * @param $column_new New
 *        	name for the column (set to the same as $column if you don't want to change the name)
 * @param $type Type
 *        	of column
 * @param $attributes Additional
 *        	optional attributes. Recognized attributes:
 ...
 *
 * @param $module The
 *        	module whose update will be run.
 * @param $number The
 *        	update number to run.
 * @param $context The
 *        	batch context array
 */
